...
describe("StddevComponent", () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [StddevComponent], // Importar el componente independiente
      providers: [MediaComponent], // Proveer MediaComponent para evitar NullInjectorError
    }).compileComponents();

    fixture = TestBed.createComponent(StddevComponent);
    component = fixture.componentInstance;

    // Aquí obtenemos la instancia de MediaComponent
