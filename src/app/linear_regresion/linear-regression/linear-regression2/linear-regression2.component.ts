...
@Component({
  selector: "app-linear-regression2",
  standalone: true,
  imports: [],
  templateUrl: "./linear-regression2.component.html",
  styleUrl: "./linear-regression2.component.css",
})
export class LinearRegression2Component {
