...
@Component({
  selector: "app-linear-regression3",
  standalone: true,
  imports: [],
  templateUrl: "./linear-regression3.component.html",
  styleUrl: "./linear-regression3.component.css",
})
export class LinearRegression3Component {
